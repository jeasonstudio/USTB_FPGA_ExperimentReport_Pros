...
HD_PWD='D:/zhj/flow_light/flow_light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flowing_light.vds -m64 -mode batch -messageDb vivado.pb -notrace -source flowing_light.tcl
